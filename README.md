...
0. авіалідвоаівдаоівлда

зареєструватися у GitHub - це тут github.com
склонити собі репозиторій ______________
створити у ньому папку з іменем за шаблоном name.surname_githubusername.
створити у цій папці readme.md с чимось
зробити пул-ріквест у репозиторій _______________
додатися до чату Gitter у репозиторії, саме там ми повідомимо про дату першої зустрічі)
Зробити це потрібно до ______________
